  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'card-gradient': 'linear-gradient(145deg, rgba(255,255,255,0.9) 0%, rgba(249,250,251,0.7) 100%)',
      },
      boxShadow: {
        ...
        'cta': '0 10px 30px rgba(79, 70, 229, 0.4)',
        'cta-hover': '0 20px 40px rgba(79, 70, 229, 0.5)',
      },
    },
  },
