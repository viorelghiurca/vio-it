          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-neutral-500 leading-relaxed">
                ...
                Notwendige Cookies sind immer aktiv. Analytische Cookies helfen uns, die Website zu verbessern.
              </p>
              ...
              {expanded && (
                <div className="mt-4 space-y-3">
                  <CookieItem
                    icon={<Shield className="w-4 h-4 text-accent-500" />}
                    name="Notwendige Cookies"
                    desc="Für die Grundfunktionen der Website erforderlich. Immer aktiv."
                    always
                  />
                  <CookieItem
                    icon={<Cookie className="w-4 h-4 text-primary-500" />}
                    name="Analytische Cookies"
                    desc="Helfen uns, die Nutzung der Website zu verstehen (Firebase Analytics)."
                  />
                </div>
              )}
...
function CookieItem({ icon, name, desc, always }) {
  return (
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between">
          ...
          {always ? (
            ...
            <span className="text-xs text-primary-600 font-medium">Optional</span>
          )}
        </div>
